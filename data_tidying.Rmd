...
```{r}
library(glmnet)
x_var <- data.matrix(model_3_data[, c("Season", "Month", "Year", "SITE_NAME", "carbon_monoxide","outdoor_temperature", "relative_humidity"	, "wind_direction__resultant", "wind_speed__resultant")])
