...
# Model 2: Predicting Nitrogen Dioxide AQI using all other predictors. Trying to see if relationship exists in the opposit direction and whether location has an effect.
```{r}
